...
; Version: 2022/07/15
;
; Purpose: Given a set of target values call a linear search routine to determine if each of the target values is found in a given array of unsorted integers.
...
; N - the number of elements in the array SOURCE
; NUMTARGETS - the number of elements in the array TARGETS.
